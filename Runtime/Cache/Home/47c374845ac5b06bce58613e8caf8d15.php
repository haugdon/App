    ...
    <div class="folw_shopmain">
        ...
        <div class="item-list">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <div class="inner">
                        <input type="checkbox" autocomplete="off" name="sel_cartgoods[]" value="<?php echo ($vo["fid"]); ?>"
                               id="sel_cartgoods_<?php echo ($vo["fid"]); ?>" checked=checked
                        ...
                        <div class="goods_desc">
                            ...
                            <div class="price"><span>￥<?php echo (number_format($vo["fstdprice"], 2, '.', '')); ?></span></div>
                        </div>
                        <div class="goods_number">
                            <div class="qiehuan">
                                <div class="xm-input-number">
                                    <a href="javascript:;" onclick="minus_num(<?php echo ($vo["fid"]); ?>, 225, 0,0);" id="jiannum<?php echo ($vo["fid"]); ?>" class="input-sub "></a>
                                    <input name="goods_number[<?php echo ($vo["fid"]); ?>]" type="text" class="input-num" id="goods_number_<?php echo ($vo["fid"]); ?>" onblur="change_price(<?php echo ($vo["fid"]); ?>, 225, 0)" onKeyDown='if(event.keyCode == 13) event.returnValue = false'
                                           value="<?php echo ($vo["fqty"]); ?>"/>
...
<script>
...
</script><!--add by kevin 20180106 solve:没有底部bottom--> 
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function selcart_submit() {
            ...
            if (j > 0) {
                document.formCart.action = "/index.php/Home/Checkout?sel_goods=" + sel_goods + "";
                document.formCart.elements['step'].value = 'checkout';
                document.formCart.submit();
                return true;
            }
