...
<div class="easyui-panel error" data-options="fit:true,title:'<?php if(isset($ Think["get"]["menuid "])): ?>访问出错了<?php endif; ?>',border:false" style="font-size:16px;padding:12px 48px">
