    ...
    final public function check_admin() {
        ...
        if (!session('users')) {
            ...
            if (empty($code)) {
                ...
                $secrept = "riBlWHm_AfDaTrzN2X-Sr7DGTt_CLEMBzJJ8sQldGGE";//"bekg-NY7fEx76lndg8Q9SzOIcNTPjItTBTSu2Kv4mYfr5tfv3aOrd4qeK1wkBqGh";
                $url = "https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=wx5ed2e3d5aeb3cfd1&corpsecret=riBlWHm_AfDaTrzN2X-Sr7DGTt_CLEMBzJJ8sQldGGE";//bekg-NY7fEx76lndg8Q9SzOIcNTPjItTBTSu2Kv4mYfr5tfv3aOrd4qeK1wkBqGh";
